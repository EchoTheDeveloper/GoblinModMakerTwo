...
{
    public partial class CreateHarmonyPatchViewModel : ViewModelBase
    {
        ...
        CreateHarmonyPatch createHarmonyPatch;
        CodeEditor editor;
        public CreateHarmonyPatchViewModel(CreateHarmonyPatch createHarmonyPatch, CodeEditor editor = null)
        {
            this.editor = editor;
            this.createHarmonyPatch = createHarmonyPatch;
        ...
        {
            createHarmonyPatch.Close();
        }

        private void SaveSettings()
        {
            string steamDir = createHarmonyPatch.FindControl<TextBox>("SteamDirectory").Text;
            ThemeName selectedTheme = (ThemeName)createHarmonyPatch.FindControl<ComboBox>("SelectTheme").SelectedIndex;
            bool showLineNumbers = (bool)createHarmonyPatch.FindControl<CheckBox>("ShowLineNumbers").IsChecked;
        ...
        private void AutoFindSteamDirectory()
        {
            ...
            createHarmonyPatch.FindControl<TextBox>("SteamDirectory").Text = directory;
        }
        ...
        {
            var selectedFiles = await createHarmonyPatch.StorageProvider.OpenFolderPickerAsync(new FolderPickerOpenOptions()
            {
                Title = "Select a Mod",
                AllowMultiple = false,
                SuggestedStartLocation = await createHarmonyPatch.StorageProvider.TryGetFolderFromPathAsync(
